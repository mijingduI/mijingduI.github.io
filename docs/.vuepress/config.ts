...
const DOMAIN_NAME = 'mijingdui.github.io' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      lang: 'zh-CN',
      title: "阿星的精神时之屋",
      description: '互联网技术博客，包含Java、C#、Golang、易语言、游戏逆向、汇编等技术文章。',
    }
  },
  ...
  themeConfig: {
    ...
    repo: 'mijingduI/mijingdui.github.io', // 导航栏右侧生成Github链接
    ...
    author: {
      name: '日暮', // 必需
      link: 'https://github.com/mijingduI', // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:727539981@qq.com',
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/mijingduI',
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
  ...
  plugins: <UserPlugins>[
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        choosen: 'gitalk',
        options: {
          clientID: 'ece994c51241ae0e0b55',
          clientSecret: 'd5a78200461b7e1192b664f911c432d3fa610235',
          repo: 'mijingdui.github.io', // GitHub 仓库
          owner: 'mijingduI', // GitHub仓库所有者
          admin: ['mijingduI'], // 对仓库有写权限的人
