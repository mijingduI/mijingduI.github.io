...
export default <VdoingThemeConfig> ({
  ...
  defaultMode: 'dark', // 默认主题外观模式，用户未在页面手动修改过模式时才生效，否则以用户设置的模式为准，可选值：'auto' | 'light' | 'dark' | 'read'
  ...
  social: {
    ...
    icons: [
      ...
      },
      {
        ...
        title: "Gitee",
        link: "https://gitee.com/mijingduI",
      },
      {
        iconClass: "icon-rss",
        title: "网站首页",
        link: "https://mijingdui.github.io/",
      },
      {
        iconClass: "icon-QQ",
        title: "QQ",
        link: "http://wpa.qq.com/msgrd?v=3&uin=727539981&site=qq&menu=yes",
      },
      /*{
